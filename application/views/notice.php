...
<body ontouchstart="">
	...
	if ($notices==NULL) {
		...
		echo '<div class="no-notice" style="display:none;">';
	}
	?>
		...
		<?php 
		if ($notices==NULL) {
			echo '<div class="notice-list-box" style="display:none;">';
		}else{
			echo '<div class="notice-list-box">';
		}
		?>
			...
			foreach ($notices as $value) {
				$value['time'] = date("m-d",strtotime($value['time']));
				echo '<li class="notice-list">
					...
					<div class="notice-conten-box">
						...
						<div class="notice-content">
							<div>您已成功提现！</div>
							<div>提现金额：<span style="color: rgb(255,180,1);">'.$value['cash'].'元</span></div>
						</div>
