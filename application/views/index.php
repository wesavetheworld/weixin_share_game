...
<head>
	...
	body{
		...
		background-size:100%;
		background-image: url(/resources/frozenui/1.2.1/img/banner2.jpg);
...
<body ontouchstart="">
	<div class="index-container">
		...
		<div id="start-share">
			<a href="<?=$detail_link;?>">
			<img src="/resources/frozenui/1.2.1/img/tiyan1.png" id="start-share-img"></a>
		</div>
    ...
    <script src="/resources/frozenjs/lib/sea.js"></script>
...
<script type="text/javascript">
    ...
    <script type="text/javascript">
    // seajs.use("/resources/frozenjs/lib/animatex1",function(Animatex) {
    //     //需要传的数据
