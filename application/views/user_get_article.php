...
<body ontouchstart="">
			...
			<div class="bottom-menu">
				...
				if ($is_get=='yes') {
					...
					echo '<div class="other-menu">
						<a href="/index.php/share/show_detail?p='.$p.'&f='.$f.'&g='.$g.'" class="get-new" style="background-img:none;">轻轻松松赚钱</a>
						<a href="/index.php/share/show_detail?p='.$p.'&f='.$f.'&g='.$g.'" class="share-friend ">开始赚钱</a>
						</div>';	
				}
	...
	var _scroollTop={
	    _top:function(id,delay,move){
	        setTimeout(function(){
	            ...
	            // var scroll_offset = document.documentElement.scrollTop||document.body.scrollTop;
	            // alert(scroll_offset);
	            $("body,html").animate({
	...
	var _backTop = function(){
	    $(".fanUp").click(function(){
	        _scroollTop._top(".detail-container",500,500);
	    });
	...
	$(document).ready(function(){
		...
		var baner_offset = $('.bottom-banner').offset().top;
		 window.onscroll=function(){
		     if(document.documentElement.scrollTop > 200 || document.body.scrollTop > 200) {
		         alert(document.documentElement.scrollTop+'+' baner_offset);
		     }
		     else {
		         $(".fanUp").fadeOut(500);
		     }
